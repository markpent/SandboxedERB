...
== Why?
I'm currently using Liquid templates in my application to generate emails/pdfs. I'm planning on taking the next step and using liquid to skin (and offer customers to skin) thier website. This then raises the issue of performance and functionailty. 
Liquid does not allow passing parameters to drops easily, and I have found assigning/updating variables within templates to be messy (i.e. keeping a running counter using +=). I have also hit issue using complex if statements. 
Liquid has been great for what i have already achieved, its just starting to show its limits....
